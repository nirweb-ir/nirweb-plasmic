...
import Label from "../../Label"; // plasmic-import: xVDE94sQBVSY/component
import TextInput from "../../TextInput"; // plasmic-import: 6nnori8nUMxJ/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: bu1fRvHZ8I6S/component
import Description from "../../Description"; // plasmic-import: NaAKL_Yfv3BT/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: mWGTsnJ5dVA6mVazezmiar/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: oWqoBH6of7PW/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__rk5Hf, {
          [sty.freeBoxiconEnd__rk5HFwkEav]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__rk5HFrgGzx]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__rk5HfCMyA]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__u5Uhe, {
            [sty.freeBoxiconStart__u5UhergGzx]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__u5UheCMyA]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__ndQc5)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__rlojG, {
            [sty.freeBoxiconEnd__rlojGwkEav]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__rlojGrgGzx]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__phuXt)}
                role={"img"}
              />
            ),
