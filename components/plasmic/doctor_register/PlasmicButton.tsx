...
import sty from "./PlasmicButton.module.css"; // plasmic-import: eh3S0_fLZiak/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ifZSf, {
          [sty.freeBoxcolor_neutral__ifZSfjqhLd]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__ifZSfCUkXTI5MS]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__ifZSfPcpBb]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__ifZSfLfs3]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__ifZSfKe0Zm]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__ifZSfAlhHf]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__ifZSfibz2X]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__ifZSftI5MS]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__h7Vmd, {
            [sty.freeBoxcolor_neutral__h7VmDjqhLd]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__h7Vmd7FHsE]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__h7VmdLfs3]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__h7VmdalhHf]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__h7VmDibz2X]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__h7VmDtI5MS]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__h7Vmdfa8QoJqhLd]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__iFh8U)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ymCkr, {
            [sty.freeBoxiconEnd__ymCkrk0ZlO]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__ymCkrLfs3]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__ymCkrAlhHf]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__ymCkribz2X]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__tggY5)}
                role={"img"}
              />
            ),
